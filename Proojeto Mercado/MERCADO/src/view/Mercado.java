		...
		do {
			...
			case (15):
				...
				for (Produto p : listarProdutos) {
					System.out.println("Numéro de Cadastro: " + p.getId_Produto() + "| Nome produto: "
							+ p.getNomeProduto() + "| Quantidade: " + p.getQuantidade() + "| Valor: " + p.getvalor());
				}
				break;
			...
			case (16):
				...
				System.out.println("Insira o numéro de referência do produto: ");
			...
			case (17):
				...
				System.out.println("Insira o número de cadastro da venda: ");
				vendaRemove.setId_Vendas(scan.nextInt());
				System.out.println("****** Venda removida do sistema ******");
				break;

			case (18):
				System.out.println("****** Lista de vendas ******");
				List<Vendas> listarVendas = new ArrayList();
				for (Vendas v : listarVendas) {
					System.out.println("Número da venda: " + v.getId_Vendas() + "| Número do cliente: "
							+ v.getId_Cliente() + "|Número referência produto: " + v.getId_Produto()
							+ "| Número Vendedor: " + v.getId_Funcionario());
				}
				break;
			// sair
			default:
